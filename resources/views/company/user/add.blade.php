                            ...
                            <form action="{{ route('company.store.user') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" id="website_available_days" name="website_available_days"
                                                class="form-control date" placeholder="Ex: 2020/07/15">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="file" name="attached_file" id="attached_file" class="form-control"
                                                placeholder="Enter your Attached file">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="youtube_video" id="youtube_video" class="form-control"
                                                placeholder="Enter your Youtube Link Video">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="whatsapp" id="whatsapp" class="form-control"
                                                placeholder="Enter your Wattsapp Link">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="md-form amber-textarea active-amber-textarea col-sm-6">
                                        ...
                                        <textarea id="about" name="about" class="md-textarea form-control"
                                            rows="14"></textarea>
                                    </div>
