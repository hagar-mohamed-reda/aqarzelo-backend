                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="{{ route('post.update',$post->id) }}" method="POST"   enctype="multipart/form-data">
                              ...
                              <label for="title">Title</label>
                                ...
                                <div class="form-group">
                                 ...
                                 <label for="build_date">Build Date</label>
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="build_date" value="{{ $post->build_date }}" name="build_date" class="form-control date" placeholder="Ex: 1915">
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-sm-6">
                                      <label for="space">Space</label>
                                        <div class="form-group">
                                           <div class="form-line">
                                               <input type="text" id="space" value="{{ $post->space }}"  name="space" class="form-control" placeholder="Enter space">
                                           </div>
                                         </div>
                                     </div>
                                      ...
                                      <label for="price_per_meter">Price Per Meter</label>
                                        <div class="form-group">
                                           <div class="form-line">
                                               <input type="text" id="price_per_meter" value="{{ $post->price_per_meter }}"  name="price_per_meter" class="form-control" placeholder="Enter price per meter">
                                           </div>
                                         </div>
                                     </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="bedroom_number" value="{{ $post->bedroom_number }}" name="bedroom_number" class="form-control" placeholder="Enter Bedroom No.">
                                    </div>
                                </div>
                                </div>
                                  <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="bathroom_number"  value="{{ $post->bathroom_number }}"  name="bathroom_number" class="form-control" placeholder="Enter Bathroom No.">
                                    </div>
                                      </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="floor_number" value="{{ $post->floor_number }}" name="floor_number" class="form-control" placeholder="Enter Floor No.">
                                    </div>
                                </div>
                                </div>
                                 <div class="col-sm-3">
                        ...
                        <div class="row" style="padding: 5px" >
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-6 w3-display-container post-image-{{ $image->id }}"  >
                                <div class="w3-display-topright w3-padding" >
                                    <button class="btn btn-primary fa fa-trash w3-margin" onclick="removeImage('{{ $post->id }}', '{{ $image->id }}')" type="button" ></button>
                                </div>
                                <img class="img-responsive img-thumbnail" src="{{ asset('images/posts') ."/". $image->photo }}" style="height: 150px; width: 100%" alt="">
                            </div>
                            @endforeach
...
function removeImage(postId, imageId) {
    ...
    $.post('{{ url("admin/post/images/remove/") }}/'+imageId, $.param(data), function(r){
        if (r.status == 1) {
