                            ...
                            <form action="{{ route('user.store') }}" method="POST"  enctype="multipart/form-data">
                             ...
                             <div class="col-sm-6">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="file"  name="attached_file" id="attached_file" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  name="facebook" id="facebook" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
                                 <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  name="youtube_link" id="youtube_link" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  name="youtube_video" id="youtube_video" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  name="whatsapp" id="whatsapp" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  name="twitter" id="twitter" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  name="linkedin" id="linkedin" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  name="website" id="website" class="form-control" placeholder="Enter your user limit">
                                    </div>
                                </div>
                                </div>
