    ...
    <div class="conference-timeline-content">
      ...
      <div class="timeline-article">
        <div class="content-left-container">
          <div class="content-right">
            <p>
                <b class="w3-text-gray text-capitalize" >{{ __('mobile.country') }} * </b>
                <div class="post-timeline-content" >
                    <br>
                    <b class="w3-text-gray" >{{ __('mobile.country') }}</b>
                    <br>
                     <select class="w3-round-large w3-light-gray btn btn-default w3-block btn-lg shadow" style="height: 50px;padding-left:25px!important;padding-right:25px!important"  v-model="post.country_id" style="margin-bottom: 7px" >
        ...
        <div
        class="meta-date w3-display-container"
        v-bind:style="post.country_id? 'background-color: #06D9B2 !important' : 'background-color: white!important' "
        onclick="$('.post-timeline-content').hide();$(this).parent().find('.post-timeline-content').toggle()"   >
            <div class="w3-display-topmiddle w3-padding"
            style="z-index: 3;padding-top: 10px!important"
            >
                <img src="{{ url('/mobile/images/create-post/city.png') }}"
                v-bind:class="post.country_id? 'invert' : ''"
                  class="icon" width="30px"  >
            </div>
        </div>
      </div>
                ...
                <div class="post-timeline-content" >
                    ...
                    <br>
                     <select class="w3-round-large w3-light-gray btn btn-default w3-block btn-lg shadow" style="height: 50px;padding-left:25px!important;padding-right:25px!important"  v-model="post.city_id" style="margin-bottom: 7px" >
                        ...
                        <option value="{{ $city->id }}" v-if="post.country_id == '{{ $city->country_id }}'"  >{{ session("direction")=='rtl'? $city->name_ar : $city->name_en }}</option>
                        @endforeach
                    </select>
                </div>
            </p>
