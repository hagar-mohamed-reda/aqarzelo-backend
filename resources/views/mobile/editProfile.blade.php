                ...
                <ul class="w3-ul profile-items"   > 
                    <li>
                        ...
                        <div class="w3-display-container" >
                            ...
                            <b class="light-theme-color w3-right text-capitalize" onclick="$('.image-input').click()" >{{ __('mobile.edit') }}</b>
                    ...
                    <li>
                        ...
                        <div class="w3-display-container" >
                            ...
                            <b class="light-theme-color w3-right text-capitalize" onclick="$('.cover-input').click()" >{{ __('mobile.edit') }}</b>
