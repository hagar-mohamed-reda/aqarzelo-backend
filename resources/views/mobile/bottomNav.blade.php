                ...
                <div class="application-bottom-nav w3-display-bottomleft w3-block w3-padding shadow w3-white" style="position: fixed;!important" >
                    <div class="w3-block bottom-nav-content w3-padding w3-row w3-light-grey " >
                        ...
                        class="w3-center btn fa fa-map-marker w3-xlarge w3-text-gray home-bottom-nav-item  light-theme-color-hover w3-col l3 m3 s3" ></div>
                        ...
                        <div
                        onclick="if (localStorage.getItem('api_token')) {loadPage('/phone/favourite');} else {errorToast('{{ __('mobile.login_first') }}');}"
                        ...
                        <div
                        onclick="if (localStorage.getItem('api_token')) {loadPage('/phone/notification');} else {errorToast('{{ __('mobile.login_first') }}');}"
