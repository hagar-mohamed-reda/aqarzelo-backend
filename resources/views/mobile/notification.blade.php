...
<style type="text/css">
    ...
    <div class="home dark-theme-background" id="page" v-bind:style="'height: ' + height + 'px'" >
        ...
        <div class="w3-display-container notification-container" v-bind:style="'height: ' + (height - 80) + 'px'" >
            <ul class="w3-ul">
                ...
                class="animated fadeInUp notification-item shadow light-theme-background-hover"  >
                    ...
                    style="padding: 0px!important">
                      ...
                      <div class="media-body w3-padding">
                        <div class="w3-text-gray w3-tiny" v-html="notification.created_at" ></div>
