...
<body>
  ...
  <section id="maincontent">
    <div class="container">
      ...
      <div class="row" >
        <ul class="portfolio-area da-thumbs" id="about">
  ...
  <section id="maincontent">
    <div class="container">
      <div class="row">
        ...
        <img  width="400px"  src="{{ asset('images/user') ."/". $user->photo }}" alt="" class="img-fluid img-rounded fat-ab">
